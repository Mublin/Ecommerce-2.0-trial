...
export default function PlaceOrderScreen () {
    ...
    const round2 = (num) =>Math.round(num * 100 + Number.EPSILON) / 100  //123.4567 => 123.46
    cart.itemsPrice = round2( cart.cartItems.reduce((a,c)=> a + c.quantity * c.price, 0))
    // cart.shippingPrice = cart.itemsPrice > 100 ? round2(0) : round2(10);
    cart.transportPrice = round2(500)
    cart.totalPrice = cart.itemsPrice + cart.transportPrice;
    const placeOrderHandler = async () => {
        try {
            ...
            const {data} = await axios.post(`/api/orders`, {
                ...
                transportPrice: cart.transportPrice,
                        ...
                        <Card>
                            <Card.Body>
                                ...
                                <ListGroup.Item>
                                        <Row>
                                            <Col>Transport</Col>
                                            <Col>${cart.transportPrice.toFixed(2)}</Col>
                                        </Row>
                                </ListGroup.Item>
                                <ListGroup.Item>
                                        <Row>
